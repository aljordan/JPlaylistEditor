package org.alansaudiotagger.audio.asf.tag;
...
{
    /** Logger Object  */
    public static Logger logger = Logger.getLogger("org.alansaudiotagger.audio.asf.tag");
    ...
    private byte[] createRawContent(byte[] data,int pictureType,String description)
    {
        ...
        //ImageDataSize
        baos.write(org.alansaudiotagger.audio.generic.Utils.getSizeLEInt32(data.length),0,4);
    ...
    private void processRawContent() throws UnsupportedEncodingException
    {
        ...
        //ImageDataSize
        imageDataSize=org.alansaudiotagger.audio.generic.Utils.getIntLE(this.getRawContent(), 1, 2);
