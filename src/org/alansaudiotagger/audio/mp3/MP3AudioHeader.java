 ...
 */
package org.alansaudiotagger.audio.mp3;

import org.alansaudiotagger.audio.AudioHeader;
import org.alansaudiotagger.audio.exceptions.InvalidAudioFrameException;
import org.alansaudiotagger.logging.Hex;
...
public class MP3AudioHeader implements AudioHeader
{
    ...
    //Logger
    public static Logger logger = Logger.getLogger("org.alansaudiotagger.audio.mp3");
