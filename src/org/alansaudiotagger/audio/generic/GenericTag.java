...
import org.alansaudiotagger.tag.mp4.field.Mp4TagCoverField;
...
public abstract class GenericTag extends AbstractTag
{
    ...
    private class GenericTagTextField implements TagTextField
    {
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#copyContent(org.alansaudiotagger.tag.TagField)
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagTextField#getContent()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagTextField#getEncoding()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#getId()
         */
        public String getId()
        {
            return id;
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#getRawContent()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#isBinary()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#isBinary(boolean)
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#isCommon()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagField#isEmpty()
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagTextField#setContent(java.lang.String)
         */
         ...
         * (overridden)
         *
         * @see org.alansaudiotagger.tag.TagTextField#setEncoding(java.lang.String)
         */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#getCommentId()
     */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#getGenreId()
     */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#getTitleId()
     */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#getTrackId()
     */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#getYearId()
     */
     ...
     * (overridden)
     *
     * @see org.alansaudiotagger.audio.generic.AbstractTag#isAllowedEncoding(java.lang.String)
     */
