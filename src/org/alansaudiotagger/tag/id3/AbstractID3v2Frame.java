...
import org.alansaudiotagger.tag.TagOptionSingleton;
...
public abstract class AbstractID3v2Frame extends AbstractTagFrame implements TagField
{
    ...
    public AbstractID3v2Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("org.alansaudiotagger.tag.id3.framebody.FrameBody" + identifier);
