...
import org.alansaudiotagger.tag.EmptyFrameException;
import org.alansaudiotagger.tag.InvalidFrameException;
import org.alansaudiotagger.tag.InvalidFrameIdentifierException;
import org.alansaudiotagger.tag.id3.framebody.AbstractID3v2FrameBody;
import org.alansaudiotagger.tag.id3.framebody.FrameBodyDeprecated;
import org.alansaudiotagger.tag.id3.framebody.FrameBodyUnsupported;
...
public class ID3v22Frame extends AbstractID3v2Frame
{
    ...
    public ID3v22Frame(String identifier)
    {
        ...
        try
        {
            Class<AbstractID3v2FrameBody> c = (Class<AbstractID3v2FrameBody>) Class.forName("org.alansaudiotagger.tag.id3.framebody.FrameBody" + bodyIdentifier);
